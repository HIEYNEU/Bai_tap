	...
	public static void main(String[] args) {
		...
		do {
			...
			case 1:
				...
				case 1:
					...
					for(int i=0;i<sosach;i++) {
						...
						Inventory.addToInventory(new VanHoc(name,tacGia,gia,slg,taiban,theLoai));
					}
					break;
				case 2:
					...
					for(int i=0;i<sosach;i++) {
						...
						System.out.print("Nhap vao the loai sach: ");
						String theLoai=in.nextLine();
						Inventory.addToInventory(new KhoaHoc(name,tacGia,gia,slg,xuatban,theLoai));
					}
					break;
				case 3:
					...
					for(int i=0;i<sosach;i++) {
						...
						System.out.print("Nhap vao the loai sach: ");
						String theLoai=in.nextLine();
						Inventory.addToInventory(new NgoaiVan(name,tacGia,gia,slg,isbn,theLoai));
					}
					break;
				}
				break;
			...
			case 3:
				...
				if(Cart.addToCart(ID, quarity)) Cart.pay(ID, quarity, needpay);
				break;
			case 4:
				System.out.println("Danh sach cac loai sach");
